...
function capitalA(s) {
    // Add your logic.
    let re = /A$/;
    let re1 = /[!-@]/;//i used the range because the number is between the simples in ASCII code
...
function imagesSearcher(text) {
    let arr = [];
    // Add your logic.
    let re = /\w{1,}\.(jpg|jpeg|png)/g
    let image = text.match(re);
    arr = image==null?arr:image;
    return arr
}
